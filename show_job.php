...
<body class="bg-dark">
<body background=
"https://th.bing.com/th/id/R.c82e5346b1d28d6b616037ffa1d92b58?rik=%2f9JHunpRUcv2uA&riu=http%3a%2f%2fwonderfulengineering.com%2fwp-content%2fuploads%2f2014%2f09%2fyellow-wallpaper-23.jpg&ehk=LytHOfNSfhdQK4IgHe1KR2T7iUfLXHAu0lbAc5YNMjs%3d&risl=&pid=ImgRaw&r=0">
</body>
    <div class="container">
        <div class="row mt-7">
            <div class="col">
...
*/
                        try {
                            ...
                            */$showquery = $conn->prepare("SELECT * from user_job");
                            $showquery->execute();
